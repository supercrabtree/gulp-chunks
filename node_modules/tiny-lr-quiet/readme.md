> This is a temporary fork of [mklabs/tiny-lr](https://github.com/mklabs/tiny-lr), because that project has gone quiet. The only difference is it doesn't console.log. Published on NPM as `tiny-lr-quiet`.
